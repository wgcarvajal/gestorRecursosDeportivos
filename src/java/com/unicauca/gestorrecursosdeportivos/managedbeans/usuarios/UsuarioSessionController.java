package com.unicauca.gestorrecursosdeportivos.managedbeans.usuarios;
    ...
    public void login()throws IOException, ServletException 
    {
        ...
        if (req.getUserPrincipal() == null) {
            try 
            {
                ...
                {
                    FacesContext.getCurrentInstance().getExternalContext().redirect("/GestorRecursosDeportivos");
                }
                else
                {
