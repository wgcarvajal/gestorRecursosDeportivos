 ...
 */
@Entity
@Table(name = "USUARIOGRUPO", catalog = "recursosDeportivos", schema = "")
@XmlRootElement
@NamedQueries({
...
public class Usuariogrupo implements Serializable {
    ...
    public String toString() {
        return "com.unicauca.gestorrecursosdeportivos.entities.Usuariogrupo[ usuariogrupoPK=" + usuariogrupoPK + " ]";
    }
